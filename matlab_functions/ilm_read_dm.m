function [data, n_data] = ilm_read_dm(filename)
    ...
    try
        if isfield(tags.ImageList.Unnamed1.ImageData.Dimensions, 'Unnamed2') == 0
            %image
            data = reshape(tags.ImageList.Unnamed1.ImageData.Data.Value,tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed0.Value,tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed1.Value);
            data = permute(data,[2 1]);
        else
            %3D image, e.g. EELS map
            data = reshape(tags.ImageList.Unnamed1.ImageData.Data.Value,tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed0.Value,tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed1.Value, tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed2.Value);
